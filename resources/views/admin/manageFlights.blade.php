                      ...
                      <tbody>
                        @foreach ($flights as $flight)
                          <tr>
                            ...
                            <td><a type="button" href="{{ route('user.detailsFlightBook', ['flight_book_id' => $flight->id]) }}" class="btn btn-info form-group">Details</a></td>
                            <td><a type="button" href="{{ route('user.deleteFlightBook', ['flight_book_id' => $flight->id]) }}" class="btn btn-danger">Delete</a></td>
                          </tr>
                            @endforeach
                          </tbody>
                        </table>
